...
import static org.onosproject.pipelines.basic.pro.BasicConstants.EGRESS_PORT_COUNTERS_EGRESS_EGRESS_PORT_COUNTER;
import static org.onosproject.pipelines.basic.pro.BasicConstants.INGRESS_PORT_COUNTERS_INGRESS_INGRESS_PORT_COUNTER;
...
public class PortStatisticsDiscoveryImpl extends AbstractHandlerBehaviour implements PortStatisticsDiscovery {
    ...
    private static final long DEFAULT_P4_DEVICE_ID = 0;
